...
#stores a copy of Player 1's choice of X or O
orig_choice = copy(choice)

#Number of turns starting from turn 1
turns = 1
...
"""
while turns < 10:
    pos = input("This turn is for {choice}. Choose your position (1-9): ") #stores the position player picks to play to
    ...
    if pos not in range(1,10): 
        ...
        elif ((orig_choice == "O") and ((board['1'] == "O" and board['2'] == "O" and board['3'] == "O") or 
       ...
       elif ((orig_choice != "X") and ((board['1'] == "X" and board['2'] == "X" and board['3'] == "X") or 
              (board['4'] == "X" and board['5'] == "X" and board['6'] == "X") or 
              (board['1'] == "X" and board['2'] == "X" and board['3'] == "X") or 
              (board['7'] == "X" and board['4'] == "X" and board['1'] == "X") or 
              (board['8'] == "X" and board['5'] == "X" and board['2'] == "X") or 
       ...
       #If Player 1 is not O and there are 3 O's in a valid tic-tac-toe row, then Player 2 is declared winner and game ends
        ...
        if (turns == 9): #If the number of turns is equal to 9 (max # of turns in a game) and there has been no winner
